 ...
 *       &lt;attribute name="MoveAndTrack" type="{http://www.onvif.org/ver10/schema}StringList" /&gt;
...
public class Capabilities {
    ...
    @XmlAttribute(name = "MoveAndTrack")
    protected List<String> moveAndTrack;
    @XmlAnyAttribute
    ...
    /**
     * Gets the value of the moveAndTrack property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the moveAndTrack property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMoveAndTrack().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getMoveAndTrack() {
        if (moveAndTrack == null) {
            moveAndTrack = new ArrayList<String>();
        }
        return this.moveAndTrack;
    }
