...
public interface PTZ {
    ...
    public void geoMove(
        ...
        org.onvif.ver10.schema.GeoLocation target,
     ...
     *             
     */
    @WebMethod(operationName = "MoveAndStartTracking", action = "http://www.onvif.org/ver20/ptz/wsdl/MoveAndStartTracking")
    @SOAPBinding(parameterStyle = SOAPBinding.ParameterStyle.BARE)
    @WebResult(name = "MoveAndStartTrackingResponse", targetNamespace = "http://www.onvif.org/ver20/ptz/wsdl", partName = "parameters")
    public MoveAndStartTrackingResponse moveAndStartTracking(

        @WebParam(partName = "parameters", name = "MoveAndStartTracking", targetNamespace = "http://www.onvif.org/ver20/ptz/wsdl")
        MoveAndStartTracking parameters
    );
